                ...
                try:
                    ...
                    for P in self.__AllowedPatterns:
                        ...
                        if P.MatchesPattern(PatternString, CurrentSymbol):
                            ...
                            return 10
#----------------------------------------------------------------------------------------------------------------------
                        elif self.__MatchesPatternRotated(PatternString, P, CurrentSymbol):
                            self.__GetCell(StartRow, StartColumn).AddToNotAllowedSymbols(CurrentSymbol)
                            self.__GetCell(StartRow, StartColumn + 1).AddToNotAllowedSymbols(CurrentSymbol)
                            self.__GetCell(StartRow, StartColumn + 2).AddToNotAllowedSymbols(CurrentSymbol)
                            self.__GetCell(StartRow - 1, StartColumn + 2).AddToNotAllowedSymbols(CurrentSymbol)
...
#----------------------------------------------------------------------------------------------------------------------
        ...
        return 0
#----------------------------------------------------------------------------------------------------------------------
    def __MatchesPatternRotated(self, PatternString, P, CurrentSymbol):
        Pattern = P.GetPatternSequence()
        PatternString = ''.join(['*' if char != CurrentSymbol else char for char in PatternString])
        RotatedNinty = f'{Pattern[6]}{Pattern[7]}{Pattern[0]}{Pattern[1]}{Pattern[2]}{Pattern[3]}{Pattern[4]}{Pattern[5]}{Pattern[8]}'
        RotatedOneEighty = f'{Pattern[4]}{Pattern[5]}{Pattern[6]}{Pattern[7]}{Pattern[0]}{Pattern[1]}{Pattern[2]}{Pattern[3]}{Pattern[8]}'
        RotatedTwoSeventy = f'{Pattern[2]}{Pattern[3]}{Pattern[4]}{Pattern[5]}{Pattern[6]}{Pattern[7]}{Pattern[8]}{Pattern[0]}{Pattern[1]}'
        if PatternString == RotatedNinty or PatternString == RotatedOneEighty or PatternString == RotatedTwoSeventy:
            return True
        else: return False
#----------------------------------------------------------------------------------------------------------------------
