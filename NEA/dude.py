...
class User:
    ...
    #A function for the backend checks
    ...
    def register(self, user_id, password, first_name, last_name, class_grade, facility, facilities, facility_combobox, grade_class_combobox):
        import re
...
# class Booking:
#     def __init__(self, booking_number, facility_id, user_id, booking_start_time, booking_end_time, approved):
...
def login_page():
    ...
    ttk.Button(main_frame_login, text = 'Login', command = lambda: User.login(Id, password)).pack()
...
def register_page():
    ...
    #Widgets
    ttk.Radiobutton(main_frame, text = 'Student', variable = class_facility_bool, value = True, command = User.student_or_teacher()).pack()
    ttk.Radiobutton(main_frame, text = 'Teacher', variable = class_facility_bool, value = False, command = User.student_or_teacher()).pack()
    ...
    ttk.Button(main_frame, text = 'Register', command = lambda: User.register(user_id, password, first_name, last_name, class_grade, facility, facilities, facility_combobox, grade_class_combobox)).pack()
...
def approval_request(user):
    ...
    ttk.Button(main_frame, text = 'Check Available Timings', command = lambda: Student.display_timings_available(timing, timings_available_combobox)).pack()
    ttk.Button(main_frame, text = 'Request', command = lambda: Student.request(user, facilities, day)).pack()
